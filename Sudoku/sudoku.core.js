...
/*
    ...
    From: https://github.com/robatron/sudoku.js/
...
export const sudoku = {}; // Global reference to the sudoku library
    ...
    */
    ...
    if (nr_candidates === 1) {
        ...
        for (var pi in SQUARE_PEERS_MAP[square]) {
            ...
            candidates_new = sudoku._eliminate(candidates, peer, target_val);
